...
export function findUserById(id) {
  ...
  switch (_id) {
    ...
    default:
      return Promise.resolve({
        json: () => Promise.resolve("can not get user"),
      });
  }
}

/**
 * Mock response from /user/:id/activity
 * @param {number} id User ID
 * @returns Promise
 */
...
/**
 * Mock response from /user/:id/average-sessions
 * @param {number} id User ID
 * @returns Promise
 */
...
/**
 * Mock response from /user/:id/performance
 * @param {number} id User ID
 * @returns Promise
 */
